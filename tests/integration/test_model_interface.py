...
class TestModelRegistryIntegration(TestCase):
    ...
    def test_time_independent_model_get_forecast(self):
        ...
        self.time_independent_model.forecasts[tstring] = "forecast"
...
class TestModelFromZenodo(TestCase):
    ...
    def test_zenodo(self, mock_buildtree):
        ...
        self.assertEqual(
            os.path.basename(model_a.registry("path")),
            os.path.basename(model_b.registry("path")),
        )
        self.assertEqual(model_a.name, model_b.name)
        self.assertTrue(filecmp.cmp(model_a.registry("path"), model_b.registry("path")))
