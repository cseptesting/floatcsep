...
class TestForecastRegistry(unittest.TestCase):
    ...
    def test_call(self):
        ...
        result = self.registry_file("path")
    ...
    def test_as_dict(self):
        self.assertEqual(self.registry_file.as_dict(), "/test/workdir/model.txt")
    ...
    def test_absdir(self):
        result = self.registry_file.absdir("model.txt")
        self.assertTrue(result.endswith("/test/workdir"))

    @patch("floatcsep.registry.exists")
    def test_fileexists(self, mock_exists):
        mock_exists.return_value = True
        self.registry_file.__call__ = MagicMock(return_value="/test/path/file.txt")
        self.assertTrue(self.registry_file.fileexists("file.txt"))
