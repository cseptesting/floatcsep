...
This project is the result of a collaborative effort by the following developer and scientific
team.  
Contributions include software development, scientific design, manuscript writing, testing,
documentation, and project coordination.

We describe contributions using short free-text descriptions and, where appropriate, the CRediT
contributor roles
(https://credit.niso.org/).

## Developer and scientific team

- **Pablo Iturrieta** – GFZ Helmholtz Centre for Geosciences, Germany –
...
- **Writing – original draft** – Preparation of the initial manuscript or main documentation
  text.
