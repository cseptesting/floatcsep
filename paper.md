...
![Simplest example of a configuration file for a time-invariant, grid-based experiment with two models. \label{fig:example}](figures/fig2_example_config.png){width="300pt"}
...
- Plug in new models into a completed or ongoing (float)CSEP experiment. Since CSEP experiments are clearly defined, they can be effectively used as benchmarks for comparing and developing new forecasting models [e.g., @serafini2025next]
